<?php 
  ...
  class ViewMM extends Db implements ViewInterface{
    ...
    public function getRoomRequestDate($studentId){
      $sql = " SELECT timeStamp FROM requestRoomMaleHostel WHERE studentId = '$studentId' ";
    ...
    public function getRoomMates($studentId){
      $sql = "SELECT roomMateId FROM preferredRoomMatesMaleHostel WHERE studentId  =  '$studentId' ";
      $stmt = $this->connect()->query($sql);
   ...
   public function getRoomMateStatus($studentId){
    $sql = " SELECT roomMateId FROM preferredRoomMatesMaleHostel WHERE roomMateId = '$studentId'  ";
    $stmt = $this->connect()->query($sql);
    $stmt->fetch();
  ...
  public function getRequestStudentId($studentId){
    $sql = " SELECT studentId FROM preferredRoomMatesMaleHostel WHERE roomMateId = '$studentId' ";
    $stmt = $this->connect()->query($sql);
    $data = $stmt->fetch(PDO::FETCH_OBJ);
